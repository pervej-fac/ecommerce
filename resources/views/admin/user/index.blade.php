              ...
              <table class="table table-hover">
                ...
                @foreach ($users as $user)
                  <tr>
                      ...
                      <td>{{ $user->name }}</td>
                      <td><span class="label {{ ($user->status=='active')?'label-info':'label-warning' }}">{{ ucfirst($user->status) }} </span></td>
                      <td>
                        ...
                        @else
                          <form method="post" action="{{ route('user.restore',$user->id) }}" style="display:inline">
                              @csrf
